...
CREATE TABLE `customers` (
  ...
  `addressLine2` Nullable(varchar(50)),
  `city` varchar(50) NOT NULL,
  `state` Nullable(varchar(50)),
  `postalCode` Nullable(varchar(15)),
  `country` varchar(50) NOT NULL,
  `salesRepEmployeeNumber` Nullable(int(11)),
...
CREATE TABLE `productlines` (
  ...
  `textDescription` Nullable(varchar(4000)),
...
grant all on classicmodels.* to <USER>