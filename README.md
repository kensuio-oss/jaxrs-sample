...
P.S. Data is preloaded into the Docker. You need the below info only for custom setup.
...
* optional: `io.opentracing.contrib:span-reporter`: to define custom, combined reporters (to jaeger and Kensu);
...
#### What's being reported to Observability system (Kensu servers)
